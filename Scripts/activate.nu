...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\web\PROJECTS\8 js py php\BookRecommender\flask'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\web\PROJECTS\8 js py php\BookRecommender\flask\Scripts\deactivate.nu'
